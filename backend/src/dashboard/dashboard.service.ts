...
export class DashboardService {
  ...
  async getResumo() {
    ...
    // Gráfico 2: quantidade de vezes que cada cultura foi plantada
    // (somando todas as safras de todas as propriedades)
    ...
    // Gráfico 3: uso do solo (agricultável vs. vegetação), somado de
